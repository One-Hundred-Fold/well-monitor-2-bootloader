...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==USART1)
  {
    ...
    PA12     ------> USART1_RTS
    */
    HAL_GPIO_DeInit(GPIOA, EXT_MODEM_TX_Pin|EXT_MODEM_RX_Pin|EXT_MODEM_CTS_Pin|EXT_MODEM_RTS_Pin);
  ...
  else if(huart->Instance==USART2)
  {
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, STEPHANO_CTS_Pin|STEPHANO_RTS_Pin|STEPHANO_TX_Pin|STEPHANO_RX_Pin);
